...
public class CategoriesPanel extends javax.swing.JPanel {
    ...
    java.sql.Date sqlFA = null;
    java.sql.Date sqlFC = null;
    try {
        java.util.Date utilFA = new SimpleDateFormat("yyyy-MM-dd").parse(FA);
        java.util.Date utilFC = new SimpleDateFormat("yyyy-MM-dd").parse(FC);
        sqlFA = new java.sql.Date(utilFA.getTime());
        sqlFC = new java.sql.Date(utilFC.getTime());
    ...
    try {
        ...
        if (connection != null) {
            String sql = "INSERT INTO orders (ID, Nom, FA, FC) VALUES (?, ?, ?, ?)";
            pstmt = connection.prepareStatement(sql);
            pstmt.setInt(1, ID);
            pstmt.setString(2, Nom);
            pstmt.setDate(3, sqlFA);
            pstmt.setDate(4, sqlFC);
